...
function calc() {
  ...
  function getStaticInfo(selector, activityClass) {
    ...
    elements.forEach(function (item) {
      ...
      item.addEventListener("click", function (e) {
        ...
        elements.forEach(function (item) {
          return item.classList.remove(activityClass);
        });
  ...
  function getDinamicInfo(selector) {
    var inputs = document.querySelectorAll("".concat(selector, " input"));
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/services */ "./src/js/modules/services/services.js");
...
function forms(formSelector, timer) {
  ...
  function modalMessage(text) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_7__.openModal)(".modal", timer);
    var newDialog = document.createElement("div");
    newDialog.classList.add("modal__dialog");
    newDialog.innerHTML = "\n                <div class=\"modal__content\">\n                <div data-close class=\"modal__close\">&times;</div>\n                <div class=\"modal__title\">".concat(text, "</div>\n            </div>\n        ");
    var modal = document.querySelector(".modal").append(newDialog);
    setTimeout(function () {
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./services/services */ "./src/js/modules/services/services.js");
...
function menu() {
  ...
  var MenuItem = /*#__PURE__*/function () {
    function MenuItem(src, alt, title, descr, price, container) {
...
function modals(trigerSelector, modalSelector, modalTimer) {
  ...
  modalTriger.forEach(function (btn) {
    btn.addEventListener("click", function () {
      return openModal(modalSelector, modalTimer);
    });
  });
...
/* harmony import */ var _timer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./timer */ "./src/js/modules/timer.js");
...
function slider(_ref) {
  var containerSelector = _ref.containerSelector,
    ...
    currentSlideSelector = _ref.currentSlideSelector,
    totalSlidesSelector = _ref.totalSlidesSelector;
  //Slider

  function makeWrapp(parrentSelector) {
    ...
    (_wrapper$classList = wrapper.classList).add.apply(_wrapper$classList, classes);
    wrapper.innerHTML = parrent.innerHTML;
    parrent.innerHTML = "";
    parrent.append(wrapper);
    return wrapper;
  }
  var slider = document.querySelector(containerSelector),
  ...
  var slideCouter = 0;
  totalSlides.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_6__.getZero)(slidesQuantity);
  sliderInner.style.cssText = "\n        width: ".concat(innerWidth, "px;\n        display: flex;\n        transition: 0.5s all;\n    ");
  sliderWrapper.style.overflow = "hidden";
  slider.style.position = "relative";
  sliderInner.childNodes.forEach(function (item) {
    return item.style.width = slideWidth;
  });
  function showSlide(slide) {
    var move = slide * slideWidth.slice(0, slideWidth.length - 2);
    currentSlide.textContent = (0,_timer__WEBPACK_IMPORTED_MODULE_6__.getZero)(slide + 1);
    sliderInner.style.transform = "translateX(-".concat(move, "px)");
    indicators.childNodes.forEach(function (item) {
  ...
  indicators.childNodes.forEach(function (item, n) {
...
function tabs(tabSelector, tabContentSelector, tabParentSelector, activeClass) {
  // Tabs
  var tabheadersWrapper = document.querySelector(tabParentSelector),
  ...
  tabcontentShow();
  tabheadersWrapper.addEventListener("click", function (event) {
...
function timer(id, deadline) {
  ...
  function setTimer(container, endTime) {
    var timer = document.querySelector(container),
...
window.addEventListener("DOMContentLoaded", function () {
  var modalTimer = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)(".modal", modalTimer);
  }, 30000);
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])(".timer", "2023-12-11");
